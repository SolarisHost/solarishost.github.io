...
function select_comment_app(){
    ...
    <div class="mo_openid_table_layout">
        <table class="mo_openid_display_table">
            <tr>
                <td colspan="2">
                    <br>
                    <b><?php echo mo_sl('Select applications to add Social Comments. These commenting applications will be added to your blog post pages at the location of your comments.');?></b>
                </td>
            </tr>
        </table>
        ...
        <table id="sel_app">
            <tr>
                <td>
                    <h3><?php echo mo_sl('Select Applications');?></h3>
                    <?php echo mo_sl('If none of the below are selected, default WordPress comments will only be visible. Only selecting Default WordPress Comments will not result in any changes');?>.
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            </tr>
            <td>
                ...
                <label class="mo_openid_checkbox_container"> <b><?php echo mo_sl('Default WordPress Comments');?></b>
            ...
            <tr>
                <td>
                    ...
                    <label class="mo_openid_checkbox_container"> <b><?php echo mo_sl('Facebook Comments');?></b>
    ...
    <script>
        jQuery('#mo_openid_page_heading').text('<?php echo mo_sl('Social Comments');?>');
    </script>
<?php }
?>