...
?>
    <div class="mo_openid_table_layout">
        <form id="comment_labels" name="comment_labels" method="post" action="" >
            ...
            <br/><table class="mo_openid_display_table" style="width: 70%">
                <tr>
                    <td><b><?php echo mo_sl('Comment Section Heading');?>:</b></td>
                ...
                <tr>
                    <td><b><?php echo mo_sl('Comments - Default Label');?>:</b></td>
    ...
    <script>
        jQuery('#mo_openid_page_heading').text('<?php echo mo_sl('Customize Text For Social Comment Labels');?>');
    </script>
<?php  }